...
class TestBookingController {
    ...
    void createBooking() throws Exception {
        when(bookingClient.create(1L, bookingDtoRequestCreate))
    ...
    void getAllBookingCurrentUser() throws Exception {
        when(bookingClient.getAllBookingCurrentUser(1L, BookingState.ALL))
                .thenReturn(ResponseEntity.ok(List.of(bookingDtoResponse)));
    ...
    void getAllBookingAllItemCurrentUser() throws Exception {
        when(bookingClient.getAllBookingAllItemCurrentUser(1L, BookingState.ALL))
                .thenReturn(ResponseEntity.ok(List.of(bookingDtoResponse)));
